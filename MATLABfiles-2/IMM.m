classdef IMM
   ...
   methods
       ...
       function [spredprobs, smixprobs] = mixProbabilities(obj, sprobs)
           ...
           % Return the predicted mode probability and the mixing probabilities 
           % based on the tran-sistion matrix and the previous mode probabilities
       ...
       function [supdprobs, loglikelihood] = updateProbabilities(obj, logLambdas, sprobs)
           ...
           loglikelihood = logSumExp(supdprobs); % you might want to use the logSumExp function at the bottom of this file
